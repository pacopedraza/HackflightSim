/*
HackflightSimGameMode.cpp: game mode code for HackflightSim
...
{
	// set default pawn class to our flying vehicle
	DefaultPawnClass = AHackflightSimVehicle::StaticClass();
}
